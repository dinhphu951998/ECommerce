...
public class ProductDTO implements Serializable{
    ...
    public ProductDTO(String Id, String name, float price, int categoryId, String image1, String image2, String image3, String image4, String manufacturer, String dimension, String material, String weight, String description, String shortDescription, String otherInfo, int stock, Date dateArrivals, float saleOff) {
        this.Id = Id;
        this.name = name;
        this.price = price;
